 ...
 */
    enum class EventType : uint32_t {
        ...
        // 布局事件 (1000-1099)
        EVT_LAYOUT_SHOW_REQUEST = 1000,
        EVT_LAYOUT_HIDE_REQUEST,
        EVT_LAYOUT_VISIBILITY_CHANGED,
        EVT_LAYOUT_SWITCH_REQUEST,
        EVT_LAYOUT_SWITCH_COMPLETED,
        EVT_LAYOUT_CREATED,
        EVT_LAYOUT_DESTROYED,
        EVT_LAYOUT_UPDATED,
        EVT_LAYOUT_FOCUS_CHANGED,
        EVT_LAYOUT_RESIZED,
        EVT_LAYOUT_MOVED
    };
